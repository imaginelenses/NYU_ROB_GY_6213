...
Labs from the NYU graduate course [ROB-GY 6213: Robot Localization and Navigation](https://sites.google.com/nyu.edu/rob-gy6213/). Each lab builds progressively toward a full autonomous navigation stack. All algorithms are implemented from scratch and deployed on a physical Ackermann steering robot.

<img src="assets/robot.jpg" alt="Custom Ackermann steering robot with RPLidar and ESP32">
